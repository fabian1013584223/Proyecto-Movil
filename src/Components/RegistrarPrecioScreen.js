...
const RegistrarPrecio = () => {
 ...
 const handleSubmit = () => {
    ...
    Alert.alert('Form submitted!', JSON.stringify({ producto, precioCompra, precioVenta, descuento, fechaDescuento, estadoDescuento }));
 };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.dropdown}>
        <Picker
          ...
          onValueChange={(itemValue, itemIndex) => setEstadoDescuento(itemValue)}
        >
